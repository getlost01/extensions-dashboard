...
export default function DashboardAppPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Dashboard | Extensions Dashboard </title>
      </Helmet>
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6} md={3}>
            <AppWidgetSummary title="Total Users" total={714000} />
          </Grid>

          <Grid item xs={12} sm={6} md={3}>
            <AppWidgetSummary title="Today's New User" total={1352831} color="info" />
          </Grid>

          <Grid item xs={12} sm={6} md={3}>
            <AppWidgetSummary title="Today's Users" total={1723315} color="warning" />
          </Grid>
